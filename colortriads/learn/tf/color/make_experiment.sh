...
export LOSSES="L2RGB"  #"KL" #"L2RGB,REG,ALPHA_TV,ALPHA_BINARY"
export LOSS_WEIGHTS="1.0" #"1.0,0.0001,0.0002"
export GLIMPSES=0
export BW_INPUT=0  # fraction of the batch to grayscale, e.g. 0.25
export LEARNING_RATE=0.001
export PRELOAD_PALETTE_GRAPH="${RUN_LOC}/palette_graphs4/pg_rw_gr0w3_img512rgb_pwidth32_colors3_subdiv6/out"
export NALPHAS=4
...
# Directly add other flags here
export EXTRA_FLAGS="--n_masks=${NALPHAS}"
#E.g.:
# export EXTRA_FLAGS="--blend_l2_alpha_loss= \\
# --hist_counts_onehot=True"


export EXP_GROUP="alphas_latest"  # will create an experiment subdir in your RUN_LOC
export EXP_PREFIX="a${NALPHAS}"  # this is the prefix of your job; can set based on params being experimented on
# End of Settings --------------------------------------------------------------
